...
+----------------------------------------------------------------+----------------------------------------------------+
| 1.  Make sure the relevant package is installed (e.g. packages | ![](index_images/im_05MarkdownScratchtemplate.png) |
|     tab, install button)                                       |                                                    |
|                                                                |                                                    |
...
| 5.  **Click `OK`**.                                            |                                                    |
|                                                                |                                                    |
| 6.  A new file should appear on your screen. At the top of     |                                                    |
|     that window (by the knit button, there is a save button.   |                                                    |
|     Save it as something relevant INSIDE YOUR PROJECT FOLDER!  |                                                    |
|                                                                |                                                    |
